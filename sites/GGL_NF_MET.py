...
master_file = '/Data/GordonGulch/GGL/GGL_NF_Met/GGL_NF_Met_ExcelandMeta/GGL_NF_Met_Master_WY2020.csv'
new_file = '/Toughbook_Share/GordonGulch/GGL/Data/GGL_NF_Met_Raw/GGL_NF_MET_CR1000_GGL_NF_Met.dat'
distribute_file = '/Data/GordonGulch/GGL/GGL_NF_Met/GGL_NF_Met_ExcelandMeta/GGL_NF_Met_Distribute_WY2020.csv'
...
plotly.io.write_html(
    fig,
    file =config.dropbox_local + '/CZO/BcCZO/Data/GordonGulch/GGL/GGL_SF_Met/GGL_SF_Met_PythonScripts/1.html',
    auto_open=True
    )
...
plotly.io.write_html(
    fig2,
    file =config.dropbox_local + '/CZO/BcCZO/Data/GordonGulch/GGL/GGL_SF_Met/GGL_SF_Met_PythonScripts/2.html',
    auto_open=True
    )
...
plotly.io.write_html(
    fig3,
    file =config.dropbox_local + '/CZO/BcCZO/Data/GordonGulch/GGL/GGL_SF_Met/GGL_SF_Met_PythonScripts/3.html',
    auto_open=True
    )
