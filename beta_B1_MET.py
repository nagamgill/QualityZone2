...
master_file = 'Data/B1/B1_Met/B1_Met_QAQC/B1_Met_ExcelandMeta/B1_Met_Master_WY2019.csv'
distribute_file = 'Data/B1/B1_Met/B1_Met_QAQC/B1_Met_ExcelandMeta/B1_Met_Distribute_WY2019.csv'
raw_folder = os.path.join(dropbox_base + '/ToughBook_Share/B1/Data/B1_Met/B1_Met_WY2019/')
